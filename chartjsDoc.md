...
* `defaultFontColor` was renamed to `font.color`(alpha2) `fontColor`(alpha)
* `defaultFontFamily` was renamed to `font.family`(alpha2) `fontFamily`(alpha)
* `defaultFontSize` was renamed to `font.size`(alpha2) `fontSize`(alpha)
* `defaultFontStyle` was renamed to `font.style`(alpha2) `fontStyle`(alpha)
* `defaultLineHeight` was renamed to `font.lineHeight`(alpha2) `LineHeight`(alpha)
